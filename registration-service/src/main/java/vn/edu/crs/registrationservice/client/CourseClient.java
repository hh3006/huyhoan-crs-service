...
public class CourseClient {
    ...
    /**
     * Gọi sang course-service để trừ 1 chỗ.
     * @throws IllegalStateException nếu course-service từ chối (hết chỗ, không tìm thấy môn học)
     * @throws IllegalStateException nếu không kết nối được course-service (service đang tắt/timeout)
     */
